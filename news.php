<?php
$apikey = '2c69cfbf4d7a2561d836a864d04e9a37';
$url = "https://gnews.io/api/v4/search?q=Web%20Accessibility&lang=en&country=uk&max=10&apikey=$apikey";
...
<link rel="stylesheet" type="text/css" href="<?php echo base_url('css/newscard.css'); ?>">
        ...
        <div class="solution_cards_box">
          <div class="solution_card">
            ...
            <div class="solu_description">
              ...
              <button type="button" class="read_more_btn" onclick="window.location.href=' <?php echo $articles[$i]['url'] ?>';" >Read More</button>
            </div>
          </div>
